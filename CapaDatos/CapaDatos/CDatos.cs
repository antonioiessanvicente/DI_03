...
{
    /// <summary>
    /// Clase abstracta que define los métodos y propiedades que deben implementar las clases que la hereden.
    /// Sienta las bases para cualquier conector a base de datos.
    /// </summary>
    public abstract class CDatos
    {
        ...
        protected string MPuerto = ""; // Puerto de conexión
